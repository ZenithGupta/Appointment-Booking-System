"""
Django settings for backend project - SIMPLIFIED VERSION WITH IST TIMEZONE
...
SECRET_KEY = 'django-insecure-xnaj9ty4p$oa1l28%#c#)0+f)_%@(un@sb83bzas6t6jbmg077'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # for develpoment purposes , allowing all hosts
...
# 🔧 MAIN FIX: Changed from UTC to Asia/Kolkata for Indian Standard Time
...
# Added these lines right below STATIC_URL
...
# 🔧 SIMPLIFIED: Basic logging configuration (no file logging to avoid directory issues)
LOGGING = {
    'version': 1,
